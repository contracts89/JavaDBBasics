...
CONSTRAINT fk_deposits FOREIGN KEY(deposit_type_id) REFERENCES deposit_types(deposit_type_id),
...
employee_id INT,
deposit_id INT,
CONSTRAINT pk_employees_depostits PRIMARY KEY(employee_id, deposit_id),
CONSTRAINT fk_employees_depostits FOREIGN KEY(employee_id) REFERENCES employees(employee_id),
...
CONSTRAINT fk_credit_history FOREIGN KEY(customer_id) REFERENCES customers(customer_id)
);
...
CONSTRAINT fk_users FOREIGN KEY(customer_id) REFERENCES customers(customer_id)
);

ALTER TABLE employees
ADD manager_id INT,
ADD CONSTRAINT fk_employees2 FOREIGN KEY(manager_id) REFERENCES employees(employee_id);

ALTER TABLE employees_deposits
DROP FOREIGN KEY employees_deposits_ibfk_1;

ALTER TABLE deposits
MODIFY deposit_id INT AUTO_INCREMENT;

ALTER TABLE employees_deposits
ADD CONSTRAINT employees_deposits_ibfk_1 FOREIGN KEY(deposit_id)
...
INSERT INTO employees_deposits VALUES
(15, 4),
(20, 15),
(8, 7),
(4, 8),
...
AND CHAR_LENGTH(cit.city_name) > 7
ORDER BY c.customer_id ASC;

SELECT e_c.employee_id, e.first_name, a.account_number FROM employees_accounts AS e_c
INNER JOIN employees AS e
ON e.employee_id = e_c.employee_id
INNER JOIN accounts AS a
ON a.account_id = e_c.account_id
WHERE a.start_date > '2012-12-31'
...
WHERE c.city_id <> 5 AND c.city_id <> 4
